...
# Description:
# This script is a compilation of registry changes and disabled services
# meant to protect your security and privacy in Windows 10. (Level 2)
# More to come.
...
Write-Host -ForegroundColor DarkGreen "====================================================="
Write-Host -ForegroundColor DarkGreen "No More Dorced Updates ((Level 2))"
Write-Host -ForegroundColor DarkGreen "====================================================="
